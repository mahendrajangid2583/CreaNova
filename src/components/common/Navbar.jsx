...
import Logo from '../../assets/Logo/creanova.png'
...
const Navbar = () => {
  ...
  return (
    ...
    <div className=' relative flex h-14 items-center justify-center border-b-2 border-b-richblack-700'>
      <div className='hidden  lg:flex w-[94%] max-w-[1350px] items-center justify-between'>
        <Link to={"/"}>
            <img src={Logo} width={170} height={45} loading='lazy'/>
        </Link>
        {/* nav links */}
        <nav>
            <ul className=' flex gap-4 mr-10 text-richblack-25'>
                {
