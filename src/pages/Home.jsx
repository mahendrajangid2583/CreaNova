        ...
        <div className=' relative mx-auto flex flex-col items-center '>
            <div className=' relative mx-auto flex flex-col items-center h-auto justify-between text-white 
                ...
                <div className=' text-[36px] font-[600] text-white text-center'>
                   ...
                   <HighlightText text= {"CreaNova"}/>
                </div>
                <div className=' text-richblack-200 text-[16px] font-[500] leading-[24px] text-center'>
                With our online study programs, you can learn at your own pace, from anywhere in the world, and gain access to a wealth of resources, including interactive lessons, practice exercises, and personalized feedback from instructors—all at an affordable price for everyone. 
                </div>
                ...
                <CodeBlocks
                  ...
                  heading={
                    <div className=' text-white text-[32px] font-[600]'>
                      Unlock your <HighlightText text={"potential"} />     with our online courses.
                    </div>
                  }
